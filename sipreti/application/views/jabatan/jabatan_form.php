...
<head>
  <meta charset="UTF-8">
  <title>Kelola Jabatan - SI Preti</title>
    ...
    <div class="form-body">
      <form action="<?php echo $action; ?>" method="post">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="nama_jabatan" id="nama_jabatan" placeholder="Masukkan nama jabatan" value="<?php echo $nama_jabatan; ?>" />
