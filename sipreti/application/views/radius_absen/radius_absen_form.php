...
<head>
  <meta charset="UTF-8">
  <title>Form Radius Absen - SI Preti</title>
...
<body>
  ...
  <div class="form-container">
    <div class="form-header">
      Radius Absen <?php echo $button ?>
    </div>
    
    <div class="form-body">
      <form action="<?php echo $action; ?>" method="post">
        <div class="form-group">
          <label for="ukuran" class="form-label">Ukuran <?php echo form_error('ukuran') ?></label>
          <input type="text" class="form-control" name="ukuran" id="ukuran" placeholder="Ukuran" value="<?php echo $ukuran; ?>" />
        </div>
        
        <div class="form-group">
          <label for="satuan" class="form-label">Satuan <?php echo form_error('satuan') ?></label>
