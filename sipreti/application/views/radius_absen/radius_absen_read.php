...
<head>
  <meta charset="UTF-8">
  <title>Detail Radius Absen - SI Preti</title>
  ...
  <div class="detail-container">
    ...
    <div class="detail-body">
      <div class="info-row">
        <div class="info-col">
          <div class="info-group">
            <label class="info-label">Ukuran</label>
            <div class="info-value"><?php echo $ukuran; ?></div>
          </div>
        </div>
        
        <div class="info-col">
          <div class="info-group">
            <label class="info-label">Satuan</label>
            <div class="info-value"><?php echo $satuan; ?></div>
          </div>
        </div>
      </div>
      ...
      <div class="action-buttons">
        <a href="<?php echo site_url('radius_absen') ?>" class="btn btn-default">Kembali</a>
        <a href="<?php echo site_url('radius_absen/update/'.$id_radius) ?>" class="btn btn-primary">Edit</a>
      </div>
    </div>
  </div>
